The code and the output file here is answer to question-4. We minimized the modified cost function and estimates values of W.
...
100 Dataset generated using linspace(numpy) library to generate uniform x values in [0,1].
